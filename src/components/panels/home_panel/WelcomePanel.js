...
const WelcomePanel = () => (
    <div id="welcome_panel_content">
        <h1>Donate Goods To People Impacted By COVID-19</h1>
        <div className="block-text-container">
            <p>Many people have been negatively impacted by COVID-19. If you have food, medicine, household goods or time to make a non-contact delivery, sign up to <a href="https://forms.gle/fwSfqDd87EkQFHn78" target="_blank">donate</a>. If you are a member of the vunerable population or need assistance, sign up to <a href="https://forms.gle/cNHiYW5ep9Qx4r1x7" target="_blank">request aid</a>.</p>
        </div>
